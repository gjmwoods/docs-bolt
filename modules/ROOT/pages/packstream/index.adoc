...
Clients that negotiate a protocol version which does not support the UUID type will instead receive a backwards compatible placeholder.
The placeholder value depends on which version has been negotiated.
